  ...
  defmacro common_endpoints do
    quote do
      ...
      namespace(:project_templates) do
        ...
        mutation(:duplicate, OperatelyWeb.Api.ProjectTemplates.Duplicate)
        mutation(:archive, OperatelyWeb.Api.ProjectTemplates.Archive)
        mutation(:restore, OperatelyWeb.Api.ProjectTemplates.Restore)
        mutation(:delete, OperatelyWeb.Api.ProjectTemplates.Delete)
